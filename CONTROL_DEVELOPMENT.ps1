...
$executionPath = 'config/control/harness/executions/E2026-08-12-H0-1-R7'
...
try {
    ...
    if ($Plan) { Write-Host "[CONTROL][PLAN] executing H0.1 R7 closed-loop C22 pilot under a single Director-dispatched runtime worker" }
