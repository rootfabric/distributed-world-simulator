...
$executionPath = 'config/control/harness/executions/E2026-08-11-H0-1-R4'
...
try {
    ...
    if ($Plan) { Write-Host "[CONTROL][PLAN] planning H0.1 closed-loop C22 pilot; runtime remains gated by Director dispatch" }
