...
# PLAY must be self-sufficient: normalize Quaternius glTF URI case and finish
# the Godot editor import before attempting to load raw .gltf resources.
...
try {
    ...
    & $GodotPath --path $Root "res://scenes/labs/character/quaternius_character_lab.tscn" 2>&1 |
