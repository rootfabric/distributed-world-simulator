...
Write-Host "Tab: close/open inventory. U/L/K/H/B are disabled in CH9.2." -ForegroundColor Cyan
...
try {
    ...
    $GodotArgs = @("--path", $Root, "res://scenes/labs/character/quaternius_item_graph_equipment_lab.tscn", "--") + $UserArgs
