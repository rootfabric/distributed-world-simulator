...
$ReportPath = Join-Path $ReportDirectory "b0-message-bus-summary.json"
...
$Summary = [ordered]@{
    schema = "planet_simulator.b0_message_bus_runner_summary.v1"
...
try {
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "B0 message bus tests passed." -ForegroundColor Green
