...
try {
    ...
    $Tests = @(
        @{ Name="FFF0 contract mapping acceptance"; Script="res://tests/research/ecology/eco_evo7_fff0_contract_mapping_acceptance.gd" },
...
Write-Host "ECO.EVO7 FFF0 Contract Mapping candidate: PASS"
