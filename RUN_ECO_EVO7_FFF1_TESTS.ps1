...
try {
    ...
    $Tests = @(
        @{ Name="FFF1 functional phenotype acceptance"; Script="res://tests/research/ecology/eco_evo7_fff1_functional_phenotype_acceptance.gd" },
...
Write-Host "ECO.EVO7 FFF1 PlantFunctionalPhenotype candidate: PASS"
