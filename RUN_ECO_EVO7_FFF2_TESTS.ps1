...
try {
    ...
    $Tests = @(
        @{ Name="FFF2 morphology evolution acceptance"; Script="res://tests/research/ecology/eco_evo7_fff2_morphology_evolution_acceptance.gd" },
...
Write-Host "ECO.EVO7 FFF2 Morphology Evolution candidate: PASS"
