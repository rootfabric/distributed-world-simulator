...
try {
    ...
    $Tests = @(
        @{ Name="FFF3 light feedback acceptance"; Script="res://tests/research/ecology/eco_evo7_fff3_light_feedback_acceptance.gd" },
...
Write-Host "ECO.EVO7 FFF3 Light Feedback candidate: PASS"
