...
try {
    ...
    $Tests = @(
        @{ Name="FFF6 succession lab acceptance"; Script="res://tests/research/ecology/eco_evo7_fff6_succession_lab_acceptance.gd" },
        @{ Name="FFF5 soil/litter memory acceptance"; Script="res://tests/research/ecology/eco_evo7_fff5_soil_memory_acceptance.gd" },
...
Write-Host "ECO.EVO7 FFF6 Succession Lab candidate: PASS"
