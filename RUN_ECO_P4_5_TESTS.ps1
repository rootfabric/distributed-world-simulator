...
$null = Invoke-GodotTimed "ECO P4.5 parser/preload preflight" "res://tests/ecology/production/eco_p4_5_region_ownership_acceptance.gd" $true

$parentRun = Invoke-GodotTimed "ECO P4.4 accepted parent regression (direct committed test)" "res://tests/ecology/production/eco_p4_4_region_persistence_acceptance.gd"
$parentAggregateMatch = [regex]::Match($parentRun, 'aggregate_hash=([0-9a-f]{64})')
if (-not $parentAggregateMatch.Success -or $parentAggregateMatch.Groups[1].Value -ne $ExpectedParentP44) {
    throw "P4.4 direct parent regression aggregate mismatch"
}

$runA = Invoke-GodotTimed "ECO P4.5 region ownership A" "res://tests/ecology/production/eco_p4_5_region_ownership_acceptance.gd"
$runB = Invoke-GodotTimed "ECO P4.5 region ownership fresh process B" "res://tests/ecology/production/eco_p4_5_region_ownership_acceptance.gd"
