...
try {
    ...
    $Tests = @(
        ...
        @{ Name="PH3 morphology-resource coupling"; Script="res://tests/research/ecology/eco_ph3_morphology_resource_coupling_acceptance.gd" },
        @{ Name="PH3 visual lab headless smoke"; Script="res://tests/research/ecology/eco_ph3_visual_lab_smoke.gd" },
        @{ Name="PH3 fresh-process restart replay"; Script="res://tests/research/ecology/eco_ph3_restart_replay_probe.gd" }
    )
...
Write-Host "ECO.PH3 focused acceptance: PASS (217 assertions)"
Write-Host "ECO.PH3 visual lab smoke: PASS (17 assertions)"
Write-Host "ECO.PH3 restart replay: PASS (5 assertions)"
Write-Host "ECO.PH3 profile_hash=1051df16a4718a3bc33be99b8394da400bc8bd7d1b8e1f86a8d190229b59a67a"
Write-Host "ECO.PH3 reference_hash=58161227616f083ab29426931ce91e24f6354f5b3d96d9020af6f8b60b72a43e"
Write-Host "ECO.PH3 morphology-to-resource coupling candidate: PASS"
