...
run_script() {
    "$godot_bin" --headless --path "$repo_root" --script "$1"
}
...
run_script res://tests/research/fabric_bake0/fabric_bake_b0_2_c_acceptance.gd
run_script res://tests/research/fabric_bake0/fabric_bake_b0_2_c_playground.gd
run_script res://tests/research/fabric_bake0/fabric_bake_b0_2_d_acceptance.gd
run_script res://tests/research/fabric_bake0/fabric_bake_b0_2_d_playground.gd
