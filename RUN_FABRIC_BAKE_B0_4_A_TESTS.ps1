...
Write-Host "FABRIC-BAKE B0.4-A EXACT WINDOWS VERIFICATION"
...
try {
    ...
    foreach ($script in @(
        ...
        "res://tests/research/fabric_bake0/fabric_bake_b0_4_a_playground.gd"
    )) {
...
Write-Host "FABRIC-BAKE B0.4-A: PASS"
