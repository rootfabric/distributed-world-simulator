...
GODOT_BIN="$godot_bin" "$repo_root/RUN_FABRIC_BAKE_B0_2_E_TESTS.sh"
"$godot_bin" --headless --path "$repo_root" --script res://tests/research/fabric_bake0/fabric_bake_bridge1_acceptance.gd
"$godot_bin" --headless --path "$repo_root" --script res://tests/research/fabric_bake0/fabric_bake_bridge1_playground.gd
