...
$Tests = @(
    ...
    @{
        Path = "res://tests/characters/test_fpe_r2_s5_secondary_hand_support.gd"
        PassMarker = "FPE R2 S5 secondary-hand support: PASS"
    },
    @{
        Path = "res://tests/characters/test_fpe_r2_s5_two_hand_third_person_presenter.gd"
