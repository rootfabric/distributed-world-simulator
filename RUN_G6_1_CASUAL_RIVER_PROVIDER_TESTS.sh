...
"$ROOT_DIR/RUN_G6_FLUID_CONTRACT_TESTS.sh"
...
trap cleanup EXIT
"$GODOT_EXECUTABLE" --headless --path "$ROOT_DIR" --script res://tests/procedural/hydrology/g6_1_casual_river_provider_acceptance.gd
echo "G6.1 CasualRiverProviderV1 focused gate passed."
