...
"$ROOT_DIR/RUN_G6_2_CROSS_CELL_CONTINUITY_TESTS.sh"
...
trap cleanup EXIT
"$GODOT_EXECUTABLE" --headless --path "$ROOT_DIR" --script res://tests/procedural/hydrology/g6_3_runtime_water_surface_query_acceptance.gd
echo "G6.3 runtime WaterSurfaceQuery focused gate passed."
