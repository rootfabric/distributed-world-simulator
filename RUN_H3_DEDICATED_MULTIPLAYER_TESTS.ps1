...
$ReportPath = Join-Path $ReportRoot "h3-dedicated-multiplayer-runner-summary.json"
...
function Invoke-CheckedGodot {
    ...
    $LogPath = Join-Path $ReportRoot ("h3-{0}.log" -f $Name)
...
try {
    ...
    Write-Host "Checkpoint: v16.9.3-runtime-h3-dedicated-multiplayer"
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "H3 dedicated multiplayer profile: PASS" -ForegroundColor Green
