...
$ReportPath = Join-Path $ReportRoot "m1-unified-networked-gameplay-summary.json"
...
function Run-Step {
    ...
    $Captured = @()
    $LogPath = Join-Path $ReportRoot "m1-$Name.log"
