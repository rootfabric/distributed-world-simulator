...
$ReportPath = Join-Path $ReportDirectory "n1-reconnect-replay-runner-summary.json"
...
$Summary = [ordered]@{
    schema = "planet_simulator.n1_reconnect_replay_runner_summary.v1"
...
try {
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "N1.3 reconnect and replay tests passed." -ForegroundColor Green
