...
$ReportPath = Join-Path $ReportDirectory "n1-remote-item-command-runner-summary.json"
...
$Summary = [ordered]@{
    schema = "planet_simulator.n1_remote_item_command_runner_summary.v1"
...
try {
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "N1.2 authoritative remote item command tests passed." -ForegroundColor Green
