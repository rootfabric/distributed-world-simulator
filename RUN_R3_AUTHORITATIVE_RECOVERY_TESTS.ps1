...
$ReportPath = Join-Path $ReportDirectory "r3-authoritative-recovery-summary.json"
...
$Summary = [ordered]@{
    schema = "planet_simulator.r3_authoritative_recovery_runner_summary.v1"
...
try {
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "R3.1 authoritative recovery tests passed." -ForegroundColor Green
