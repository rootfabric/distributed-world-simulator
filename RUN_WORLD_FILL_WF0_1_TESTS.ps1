...
$ReportPath = Join-Path $ReportDirectory "world-fill-wf0-1-summary.json"
...
$Summary = [ordered]@{
    schema = "world_fill.wf0_1_runner_summary.v1"
...
try {
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "WORLD FILL WF0.1 tests passed." -ForegroundColor Green
