...
$ReportPath = Join-Path $ReportDirectory "world-fill-wf0-2-summary.json"
...
$Summary = [ordered]@{
    schema = "world_fill.wf0_2_runner_summary.v1"
...
try {
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "WORLD FILL WF0.2 tests passed." -ForegroundColor Green
