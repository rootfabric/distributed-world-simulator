...
$ReportPath = Join-Path $ReportDirectory "world-fill-wf0-3-summary.json"
...
$Summary = [ordered]@{
    schema = "world_fill.wf0_3_runner_summary.v1"
...
try {
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "WORLD FILL WF0.3 tests passed." -ForegroundColor Green
