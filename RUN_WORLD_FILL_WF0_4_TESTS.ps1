...
$ReportPath = Join-Path $ReportDirectory "world-fill-wf0-4-summary.json"
...
$Summary = [ordered]@{
    schema = "world_fill.wf0_4_runner_summary.v1"
...
try {
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "WORLD FILL WF0.4 tests passed." -ForegroundColor Green
