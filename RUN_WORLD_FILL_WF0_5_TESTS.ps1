...
$ReportPath = Join-Path $ReportDirectory "world-fill-wf0-5-summary.json"
...
$Summary = [ordered]@{
    schema = "world_fill.wf0_5_runner_summary.v1"
...
try {
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "WORLD FILL WF0.5 tests passed." -ForegroundColor Green
