...
$ReportPath = Join-Path $ReportDirectory "world-fill-wf0-6-summary.json"
...
$Summary = [ordered]@{
    schema = "world_fill.wf0_6_runner_summary.v1"
...
try {
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "WORLD FILL WF0.6 tests passed." -ForegroundColor Green
