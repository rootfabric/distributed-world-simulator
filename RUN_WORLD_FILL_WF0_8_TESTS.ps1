...
$ReportPath = Join-Path $ReportDirectory "world-fill-wf0-8-summary.json"
...
$Summary = [ordered]@{
    schema = "world_fill.wf0_8_runner_summary.v1"
...
try {
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "WORLD FILL WF0.8 tests passed." -ForegroundColor Green
