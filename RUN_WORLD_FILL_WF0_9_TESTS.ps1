...
$ReportPath = Join-Path $ReportDirectory "world-fill-wf0-9-summary.json"
...
$Summary = [ordered]@{
    schema = "world_fill.wf0_9_runner_summary.v1"
...
try {
    ...
    $Summary.passed = $true
    Save-Summary
    Write-Host "WORLD FILL WF0.9 tests passed." -ForegroundColor Green
