...
if ($FocusedOnly) {
    Write-Host "FocusedOnly validates FIX10 fix6 semantic input scheduling, one-sequence-per-fixed-tick latching, transition-aware ACK baselines and ACK dispatch, then fix5/fix4/fix3/fix2 plus FIX10/FIX9/FIX8/NX4 regressions." -ForegroundColor Yellow
}
