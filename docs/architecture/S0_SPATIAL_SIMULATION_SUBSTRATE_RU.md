...
T1 Multi-peer Transport v2 принят как `v16.8.3-network-t1-multi-peer`; B0 Message Bus Contracts реализован как candidate `v16.8.5-domain-m0-aggregate-transactions`. S0 cell/shard identity остаётся независимой от peer sessions, route generation и bus adapter routes.
