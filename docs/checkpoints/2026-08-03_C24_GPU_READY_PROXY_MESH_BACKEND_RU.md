...
## Фактический полный gate

```text
C24 focused:      2 522 assertions
C23 focused:      4 187 assertions
C22 focused:        191 assertions
C2B regression:     258 assertions
C9 regression:      204 assertions
Network N0–M4:       54 tests, 55 steps
World regression:   156/156 tests, 159 steps
Main-scene CLI:        6/6
```
