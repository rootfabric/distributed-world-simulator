...
- founder `reproductive_identity` берётся из environment-neutral LS3.2 placement identity; для recruited child он равен pre-environment mutation candidate hash;
...
- focused LS3.3 R2: `PASS (41 assertions)`;
- inherited full chain: `45 / 19 / 48 / 51 / LS2 smoke / 89 / 11369 / 24 / spatial 1024 / LS3.2 2382 / LS3.3 39`;
- runner rc: `0`;
- runtime: `81s`;
