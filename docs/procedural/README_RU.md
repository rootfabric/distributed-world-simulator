...
3. `docs/plans/PROCEDURAL_PLANETARY_GENERATION_EXECUTION_PLAN_RU.md`
4. `docs/plans/PROCEDURAL_PLANETARY_GENERATION_ROADMAP_RU.md`
5. `docs/architecture/PROCEDURAL_PLANETARY_GENERATION_FABRIC_RU.md`
6. `docs/validation/PROCEDURAL_PLANET_LAB_ACCEPTANCE_RU.md`
