...
```text
SUBJECT_HEAD = ce8013f7507ea310012ceef2d0968b26910b9348
SUBJECT_TREE = 970282ec6b8504f50a62edde639fd142a5bee1cd
...
R4 = 96d152176a813535db6950085cb10fff33c1464f
```
...
The prior pinned subject `57d274de196e...` is historical after canonical Windows double Godot exposed R2/R4 typed-array failures and R3/R5 parser inference failures. This verifier now admits only `ce8013f7507ea310012ceef2d0968b26910b9348 / 970282ec6b8504f50a62edde639fd142a5bee1cd`, containing the fixes at their owning layers.

## R4 negative-control rebind

The prior Windows subject `2d32212914de...` is historical after R4 revealed a no-op forged-event negative control. Current product `ce8013f7507ea310012ceef2d0968b26910b9348 / 970282ec6b8504f50a62edde639fd142a5bee1cd` carries the non-noop, re-sealed part/module mismatch control and no runtime semantic change.

## Fresh whole-stack authority review rebind

The previous subject `a33a9056a9d7...` remains historical PASS evidence but cannot satisfy current acceptance after review found that R1 admitted WARM as executable. Current product `ce8013f7507ea310012ceef2d0968b26910b9348 / 970282ec6b8504f50a62edde639fd142a5bee1cd` requires ACTIVE for ECO cursor/site execution and retains WARM only as R3 handoff preparation state. Verifier must run the new subject on both canonical platforms.

## Fresh trust review R2 rebind

Current subject `ce8013f7507ea310012ceef2d0968b26910b9348 / 970282ec6b8504f50a62edde639fd142a5bee1cd` additionally requires WARM-only handoff preparation, caller-owned R4 event binding-hash authority, and valid-rehash falsifiers for the R1 damage record and R2 Matter batch anchors. All earlier subjects are historical after these trust-boundary repairs.

## Verifier-only R4 refresh

The prior product subject differed only by a broken R4 Python verifier line containing a literal `\\n`. Current product `ce8013f7507ea310012ceef2d0968b26910b9348 / 970282ec6b8504f50a62edde639fd142a5bee1cd` inherits R4 `96d152176a813535db6950085cb10fff33c1464f`; no GDScript runtime adapter/test semantics changed from the independently reviewed subject.
