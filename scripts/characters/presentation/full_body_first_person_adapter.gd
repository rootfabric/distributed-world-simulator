...
func create_report() -> Dictionary:
	...
	return {
		...
		"first_person_shadow_policy": String(base_report.get("first_person_shadow_policy", "NONE")),
		...
		"shadow_preservation_enabled": bool(base_report.get("shadow_preservation_enabled", false)),
		"shadow_proxy_ready": bool(base_report.get("shadow_proxy_ready", false)),
		"shadow_proxy_active": bool(base_report.get("shadow_proxy_active", false)),
		"shadow_proxy_count": int(base_report.get("shadow_proxy_count", 0)),
		"shadow_proxy_skinned_count": int(base_report.get("shadow_proxy_skinned_count", 0)),
		"shadow_proxy_skeleton_bound_count": int(base_report.get("shadow_proxy_skeleton_bound_count", 0)),
		"shadow_proxy_shared_mesh_count": int(base_report.get("shadow_proxy_shared_mesh_count", 0)),
		"shadow_caster_preserved": bool(base_report.get("shadow_caster_preserved", false)),
		...
		"shadow_render_layer_mask": int(base_report.get("shadow_render_layer_mask", 0)),
		"render_layers_distinct": bool(base_report.get("render_layers_distinct", true)),
	}
