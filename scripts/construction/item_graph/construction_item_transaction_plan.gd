...
const COMMAND_TYPES: Array[String] = [COMMAND_ASSEMBLE, COMMAND_DECONSTRUCT, COMMAND_ADVANCE_STAGE, COMMAND_FABRICATION_RESERVE, COMMAND_FABRICATION_COMPLETE, COMMAND_FABRICATION_RELEASE]
