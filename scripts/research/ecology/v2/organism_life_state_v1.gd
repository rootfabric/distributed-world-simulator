...
const MUTATION_RECEIPT_SCHEMA := "dws.ecology.mutation-receipt.v1"
const MUTATION_TRANSFER_RECEIPT_SCHEMA := "dws.ecology.parent-mutation-transfer-origin-receipt.v1"
const ORIGINS := ["FOUNDER_ENDOWMENT", "PARENT_TRANSFER", "PARENT_MUTATION_TRANSFER"]
