...
def parse_log(path: Path, expected_count: int) -> dict[str, Any]:
    ...
    if c.get("lifecycle_metadata_parts_scanned")!=2*expected_count-20: raise ValueError("R5_1_LIFECYCLE_SCAN_DRIFT")
...
def main() -> int:
    ...
    for count in COUNTS:
        ...
        row={
            ...
            "lifecycle_metadata_parts_scanned":2*count-20,
    ...
    result={
        ...
        "correctness":{
            ...
            "metadata_scan_contract":"parent=N; lifecycle=2N-20; explicit_global_control=N",
        },
        "cases":by_count,
