...
func _init() -> void:
	...
	_assert(String(ready.get("checkpoint", "")) in ["v16.11.0-network-nx1-deterministic-condition-simulator", "v16.12.0-network-nx2-realtime-traffic-separation", "v16.13.0-network-nx3-fixed-tick-authoritative-simulation", "v16.14.0-network-nx4-client-prediction-reconciliation"], "Server reports current network checkpoint")
