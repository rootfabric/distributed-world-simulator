...
func _test_telemetry_and_runtime_wiring() -> void:
	...
	_assert(RuntimeIdentity.CHECKPOINT in ["v16.11.0-network-nx1-deterministic-condition-simulator", "v16.12.0-network-nx2-realtime-traffic-separation"], "Runtime identity no longer includes accepted NX1 capability")
