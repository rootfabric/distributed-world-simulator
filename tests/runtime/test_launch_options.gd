...
func _init() -> void:
	...
	_assert(String(default_descriptor.get("checkpoint", "")) == "v16.4.0-foundation-n0", "Default descriptor checkpoint is stale")
	_assert(String(default_descriptor.get("build_id", "")) == "foundation-n0-contracts-handoff-kernel-ports", "Default descriptor build id is stale")
