...
func _run_actor_p3() -> void:
	...
	var reconnect_resource := client.get_resource_mining_snapshot()
	var reconnect_item := client.get_item_graph_snapshot()
...
func _run_after_p3() -> void:
	...
	await _wait_frames(5)
	var resource := client.get_resource_mining_snapshot()
	var item := client.get_item_graph_snapshot()
